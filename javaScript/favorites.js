...
export class FavoritesView extends Favorites {
  ...
  onadd() {
    const addButton = this.root.querySelector(".search-user");
  ...
  creatRow() {
    ...
    tr.innerHTML = `
        <td class="user">
        <img src="https://github.com/Daniel-Rosa1.png" alt="foto de Daniel">
        <a href="https://github.com/Daniel-Rosa1" target="_blank">
            <p>daniel</p>
        </a>
        <span>Daniel-Rosa1</span>
        </td>
